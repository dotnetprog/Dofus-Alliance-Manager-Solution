...
namespace DAM.Database.Migrations
{
    ...
    [Migration("20240406185453_SeasonFlexibilityEnhancements")]
    partial class SeasonFlexibilityEnhancements
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAM.Domain.Entities.AllianceConfiguration", b =>
                {
                    ...
                    b.Property<bool?>("AllowSeasonOverlap")
                        .HasColumnType("bit");

                    b.Property<decimal>("AtkScreen_DiscordChannelId")
                        .HasColumnType("decimal(20,0)");

                    b.Property<bool?>("AutoValidateNoDef")
                        .HasColumnType("bit");

                    b.Property<decimal?>("Ava_DiscordForumChannelId")
                        .HasColumnType("decimal(20,0)");

                    b.Property<string>("BehaviorScreenConfigJSONData")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("BotScreenBehaviorType")
                        .HasColumnType("int");

                    b.Property<decimal>("DefScreen_DiscordChannelId")
                        .HasColumnType("decimal(20,0)");

                    b.Property<Guid?>("DefaultBaremeAttaqueId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("DefaultBaremeDefenseId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<decimal?>("DefaultSeasonRankingChannelId")
                        .HasColumnType("decimal(20,0)");
                    ...
                    b.HasIndex("DefaultBaremeAttaqueId");

                    b.HasIndex("DefaultBaremeDefenseId");
            ...
            modelBuilder.Entity("DAM.Domain.Entities.AllianceEnemy", b =>
                {
                    ...
                    b.Property<Guid?>("BaremeAttaqueId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("BaremeDefenseId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("BaremeAttaqueId");

                    b.HasIndex("BaremeDefenseId");
            ...
            modelBuilder.Entity("DAM.Domain.Entities.Saison", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("BaremeAttackId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime?>("LadderGeneratedOn")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<decimal?>("SeasonRankingChannelId")
                        .HasColumnType("decimal(20,0)");
            ...
            modelBuilder.Entity("DAM.Domain.Entities.SaisonRanking", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<int?>("BonusPepite")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("MontantTotalPepite")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("Previous_BonusPepite")
                        .HasColumnType("int");

                    b.Property<int?>("Previous_MontantAtkPepites")
                        .HasColumnType("int");

                    b.Property<int?>("Previous_MontantAvAPepites")
                        .HasColumnType("int");

                    b.Property<int?>("Previous_MontantDefPepites")
                        .HasColumnType("int");

                    b.Property<int?>("Previous_MontantTotalPepite")
                        .HasColumnType("int");

                    b.Property<int?>("Previous_NombreParticipationAvA")
                        .HasColumnType("int");

                    b.Property<int?>("Previous_Nombre_attaques")
                        .HasColumnType("int");

                    b.Property<int?>("Previous_Nombre_defense")
                        .HasColumnType("int");

                    b.Property<int?>("Previous_PositionRank")
                        .HasColumnType("int");

                    b.Property<string>("Previous_bonusReason")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DAM.Domain.Ïdentity.AppUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DAM.Domain.Entities.AllianceConfiguration", b =>
                {
                    b.HasOne("DAM.Domain.Entities.Bareme", "DefaultBaremeAttaque")
                        .WithMany()
                        .HasForeignKey("DefaultBaremeAttaqueId");

                    b.HasOne("DAM.Domain.Entities.Bareme", "DefaultBaremeDefense")
                        .WithMany()
                        .HasForeignKey("DefaultBaremeDefenseId");

                    b.Navigation("DefaultBaremeAttaque");

                    b.Navigation("DefaultBaremeDefense");
                });
            ...
            modelBuilder.Entity("DAM.Domain.Entities.AllianceEnemy", b =>
                {
                    ...
                    b.HasOne("DAM.Domain.Entities.Bareme", "BaremeAttaque")
                        .WithMany("EnemiesAttaque")
                        .HasForeignKey("BaremeAttaqueId");

                    b.HasOne("DAM.Domain.Entities.Bareme", "BaremeDefense")
                        .WithMany("EnemiesDefense")
                        .HasForeignKey("BaremeDefenseId");

                    b.Navigation("Alliance");

                    b.Navigation("BaremeAttaque");

                    b.Navigation("BaremeDefense");
                });
            ...
            modelBuilder.Entity("DAM.Domain.Entities.AllianceMember_ScreenPost", b =>
                {
                    ...
                    b.HasOne("DAM.Domain.Entities.AtkScreensPost", "AtkScreensPost")
                        .WithMany("Members")
                        .HasForeignKey("ScreenPostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DAM.Domain.Entities.DefScreensPost", "DefScreensPost")
                        .WithMany("Members")
                        .HasForeignKey("ScreenPostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("AtkScreensPost");

                    b.Navigation("DefScreensPost");
            ...
            modelBuilder.Entity("DAM.Domain.Entities.Saison", b =>
                {
                    ...
                    b.HasOne("DAM.Domain.Entities.Bareme", "BaremeAttack")
                        .WithMany()
                        .HasForeignKey("BaremeAttackId");
                    ...
                    b.HasOne("DAM.Domain.Entities.AllianceMember", "ModifiedBy")
                        .WithMany()
                        .HasForeignKey("ModifiedById");

                    b.Navigation("Alliance");

                    b.Navigation("BaremeAttack");
            ...
            modelBuilder.Entity("DAM.Domain.Entities.SaisonRanking", b =>
                {
                    ...
                    b.HasOne("DAM.Domain.Entities.Saison", "Saison")
                        .WithMany("Rankings")
            ...
            modelBuilder.Entity("DAM.Domain.Entities.Bareme", b =>
                {
                    ...
                    b.Navigation("EnemiesAttaque");

                    b.Navigation("EnemiesDefense");
                });
