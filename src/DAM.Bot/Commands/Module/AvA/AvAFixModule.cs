...
{
    public class AvAFixModule : InteractionModuleBase<SocketInteractionContext>
    {
        ...
        public AvAFixModule(IAvAService avaService,
        ...
        [SlashCommand("ava_new", "Create a new thread channel for koth and sync it to the database")]
        public async Task Run([Autocomplete(typeof(AutoCompleteZoneEnumModule))] string zone, string message, string? SousZone = null, string? titre = null, IAttachment ScreenPrisme = null)
        {
            ...
            var currentUser = await this._allianceManagementService.GetOrCreateAllianceMember(alliance.Id, Context.User as IGuildUser);
