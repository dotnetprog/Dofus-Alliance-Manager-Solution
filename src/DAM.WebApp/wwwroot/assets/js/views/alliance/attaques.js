...
function buildCarousel(row) {
    var uid = makeid(5) + "Caroussel";
    var html = `<div id="${uid}" class="carousel slide" data-interval="false" data-bs-interval="false">
                    <ol class="carousel-indicators">
                        <li data-bs-target="#${uid}" data-bs-slide-to="0" class="active"></li>
                        <li data-bs-target="#${uid}" data-bs-slide-to="1"></li>
                    </ol>
                    <div class="carousel-inner">
                        <div class="carousel-item active" data-bs-interval="false">
                            <a class="popupImage" title="Attaque" href="${row.ImageUrl}"><img src="${row.ImageUrl}" class="d-block w-100 img-thumbnail" alt="..."></a>
                            <div class="carousel-caption d-none d-md-block">
                                <h5>Screen de victoire</h5>
                            </div>
                        </div>
                        <div class="carousel-item" data-bs-interval="false">
                           <a class="popupImage" title="Attaque" href="${row.ImagePrepUrl}"> <img src="${row.ImagePrepUrl}" class="d-block w-100 img-thumbnail" alt="..."></a>
                            <div class="carousel-caption d-none d-md-block">
                                <h5>Screen de préparation</h5>
                            </div>
                        </div>
                    </div>
                    <a class="carousel-control-prev" href="#${uid}" role="button" data-bs-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="visually-hidden">Previous</span>
                    </a>
                    <a class="carousel-control-next" href="#${uid}" role="button" data-bs-slide="next">
...
function buildCard(row) {
    ...
    if (!!row.ImagePrepUrl) {
        $(imgContainer).html(buildCarousel(row));
    ...
    var nbAttackants = row.Nombre_Enemi || 0;
    var nbAlly = row.Nombre_Allie || 0;
...
function getScreens(expand,pageSize, currentpage, filter) {
    var promise = new Promise((resolve, reject) => {
        ...
        query += "&$count=true&$orderby=CreatedOn";
        $.ajax({
            contentType: "application/json",
            async: true,
            url: `/odata/v1/${PageConfig.allianceid}/AtkScreensPosts${query || ""}`,
            type: "GET",
...
function LoadData() {
    var container = $("#screenGrid");
    //$expand=Members($select=CharacterCount;$expand=AllianceMember($select=Alias,Nickname))
...
function buildOdataFilterFromFilterObject(filterObj) {
    ...
    //Members/any(m: m/AllianceMember/DiscordId in ('348512265898819584','322225485327368193'))
